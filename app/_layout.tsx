...
import JokeImageGenerator from "./JokeImageGenerator";

// URL de l'API pour récupérer les blagues
const API_URL =
  "https://v2.jokeapi.dev/joke/Any?lang=fr&blacklistFlags=religious,political,racist,sexist&safe-mode";
...
const Joke = () => {
  ...
  if (showImageGenerator) {
    // Affiche le composant JokeImageGenerator si nécessaire
    return <JokeImageGenerator joke={joke} onBack={() => setShowImageGenerator(false)}/>;
  }  
        ...
        <View style={styles.windowContainer}>
          ...
          <View style={styles.jokeContainer}>
            ...
            <View style={styles.buttonGroup}>
              ...
              <TouchableOpacity style={styles.button} onPress={() => setShowImageGenerator(true)}>
                <View style={styles.buttonShadow}>
                  <Text style={styles.buttonText}>
                    Partager
                  </Text>
